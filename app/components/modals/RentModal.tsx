...
const RentModal = () => {
  ...
  const onSubmit: SubmitHandler<FieldValues> = (data) => {
    ...
    axios
      ...
      .then(() => {
        toast.success("Listagem criada com sucesso!");
        router.refresh();
        reset();
  ...
  let bodyContent = (
    <div className='flex flex-col gap-8'>
      <Heading
        title="Qual desses descreve melhor o seu espaço?" 
    ...
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading 
          ...
          subtitle="Ajude os convidados a te achar!"
        />
        <CountrySelect 
          value={location}
    ...
    bodyContent = (
      <div className="flex flex-col gap-8"> 
        <Heading 
          ...
          subtitle="Mostre aos seus convidados como é o seu espaço!"
        />
        <ImageUpload 
          value={imageSrc}
